...
export default function TransactionWrapper({ address, customArg }: TransactionWrapperProps ) {
  const contracts = [
    {
  ...
  const handleSuccess = (response: TransactionResponse) => {
    console.log("Blockchain transaction initiated successfully, complete it via the prompt on your phone.", response);
